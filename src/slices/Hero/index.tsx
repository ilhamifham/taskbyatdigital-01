    ...
    <section data-slice-type={slice.slice_type} data-slice-variation={slice.variation} className="last:pb-16">
      <div className="max-w-section text-center">
        <PrismicRichText
          ...
          components={{
            heading1: ({ children }) => <h1 className="heading1 mb-4 mx-auto max-w-xl xl:max-w-none">{children}</h1>,
          }}
        />
        <PrismicRichText
          field={slice.primary.paragraph}
          components={{
            paragraph: ({ children }) => <p className="paragraph1 mb-5 max-w-xl mx-auto xl:mb-6">{children}</p>,
          }}
        />
